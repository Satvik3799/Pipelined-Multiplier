module pipelined_multiplier (clk,
 ...
 sky130_fd_sc_hd__buf_2 _373_ (.A(\temp_b[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_357_));
 sky130_fd_sc_hd__clkbuf_2 _374_ (.A(\temp_a[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 _377_ (.A(\temp_a[1] ),
    ...
    .VPWR(VPWR),
    .X(_360_));
 sky130_fd_sc_hd__buf_2 _378_ (.A(\temp_b[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _381_ (.A(_362_),
    ...
    .VPWR(VPWR),
    .Y(_001_));
 sky130_fd_sc_hd__buf_2 _382_ (.A(\temp_b[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__and4_1 _395_ (.A(_357_),
    ...
    .VPWR(VPWR),
    .X(_051_));
 sky130_fd_sc_hd__buf_2 _396_ (.A(\temp_a[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_052_));
 sky130_fd_sc_hd__a22oi_1 _397_ (.A1(_361_),
    .A2(_366_),
    .B1(_052_),
    .B2(_357_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _413_ (.A(_366_),
    ...
    .VPWR(VPWR),
    .Y(_068_));
 sky130_fd_sc_hd__buf_2 _414_ (.A(\temp_a[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _432_ (.A(_364_),
    ...
    .VPWR(VPWR),
    .Y(_086_));
 sky130_fd_sc_hd__buf_2 _433_ (.A(\temp_a[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__a21o_1 _447_ (.A1(_092_),
    ...
    .VPWR(VPWR),
    .X(_101_));
 sky130_fd_sc_hd__and3_1 _448_ (.A(_084_),
    .B(_100_),
    .C(_101_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and4_1 _463_ (.A(\temp_b[0] ),
    ...
    .VPWR(VPWR),
    .X(_117_));
 sky130_fd_sc_hd__buf_2 _464_ (.A(\temp_a[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__a21o_1 _477_ (.A1(_128_),
    ...
    .VPWR(VPWR),
    .X(_131_));
 sky130_fd_sc_hd__o211a_1 _478_ (.A1(_102_),
    .A2(_104_),
    .B1(_130_),
    .C1(_131_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and4_1 _496_ (.A(\temp_a[3] ),
    ...
    .VPWR(VPWR),
    .X(_149_));
 sky130_fd_sc_hd__a22oi_1 _497_ (.A1(\temp_b[3] ),
    .A2(_069_),
    .B1(\temp_b[4] ),
    .B2(_052_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a22o_1 _502_ (.A1(\temp_b[1] ),
    ...
    .VPWR(VPWR),
    .X(_155_));
 sky130_fd_sc_hd__nand4_1 _503_ (.A(\temp_b[0] ),
    .B(\temp_b[1] ),
    .C(\temp_a[6] ),
    .D(\temp_a[7] ),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _621_ (.A(_241_),
    ...
    .VPWR(VPWR),
    .Y(_270_));
 sky130_fd_sc_hd__o21bai_1 _622_ (.A1(_246_),
    .A2(_249_),
    .B1_N(_247_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a22o_1 _669_ (.A1(_106_),
    ...
    .VPWR(VPWR),
    .X(_316_));
 sky130_fd_sc_hd__nand4_1 _670_ (.A(_118_),
    .B(_106_),
    .C(_216_),
    .D(_146_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _708_ (.A(_342_),
    ...
    .VPWR(VPWR),
    .X(_034_));
 sky130_fd_sc_hd__clkbuf_4 _709_ (.A(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_1 _754_ (.CLK(net17),
    ...
    .VPWR(VPWR),
    .Q(\temp_b[2] ));
 sky130_fd_sc_hd__dfxtp_1 _755_ (.CLK(net17),
    .D(_035_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\temp_b[3] ));
 sky130_fd_sc_hd__dfxtp_1 _756_ (.CLK(net17),
    .D(_036_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_1 _760_ (.CLK(net17),
    ...
    .VPWR(VPWR),
    .Q(\temp_a[0] ));
 sky130_fd_sc_hd__dfxtp_1 _761_ (.CLK(net17),
    .D(_041_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 input16 (.A(b[7]),
    ...
    .VPWR(VPWR),
    .X(net16));
 sky130_fd_sc_hd__buf_6 input17 (.A(clk),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
